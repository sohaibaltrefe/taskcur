...
<div className="container-fluid">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">      <th scope="col">action2</th></th>
      <th scope="col">      <th scope="col">action3</th></th>
...
<td>{user.email}</td>
<td>{user.password}</td>
<td ><button  className='   bg-dark text-bg-primary  fs-4' onClick={()=>deleteUser(user._id)}>delete</button></td>
<td><Link className=' bg-success text-bg-info fs-4 text-bg-warning p-1 mt-1  text-decoration-none' to={`/user/${user._id}`}>details </Link> </td>
<td className=' btn   btn-warning mt-2 p-1 px-2  text-body' ><Link className=' text-decoration-none text-muted fs-5' to={`/user/edit/${user._id}`}> edit</Link>  </td>
