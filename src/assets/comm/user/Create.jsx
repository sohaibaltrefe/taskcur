...
import { validationdata } from '../../valid/uservalidion';
...
if(Object.keys(validationdata(user)).length>0){
 ...
 setLoder(false);
  ...
  setErrorback(errorrs.response.data.message);
  setErorrs([]);
  setLoder(false);
  ...
  <div className="row flex-nowrap">
    ...
    <div className="col py-3">
      ...
      <form onSubmit={sendData}>
        ...
        <Input errors={errors} id={'password'} title={'user password'} customClasses=" bg-danger" type={'password'} name={'password'} handelData={handelData} />
